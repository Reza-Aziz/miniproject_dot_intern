...
function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    // Nanti bisa ditambahin logic login disini
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md lg:max-w-lg xl:max-w-xl p-6 sm:p-8 lg:p-10 mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-600 text-white py-2.5 sm:py-3 text-sm sm:text-base rounded-lg font-semibold hover:bg-indigo-700 transition duration-200 shadow-md hover:shadow-lg mt-2"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          <button className="flex items-center justify-center px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
          ...
          <button className="flex items-center justify-center px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2" fill="#1877F2" viewBox="0 0 24 24">
